      ...
      <div className="right-sidebar-wrapper overflow-y-scroll overflow-style-none 2xl:fixed 2xl:grid-cols-none 2xl:block grid lg:grid-cols-2 grid-cols-1 xl:gap-7 gap-4 h-full 2xl:pb-96  md:p-8">
            ...
            <div className="flex space-x-2 items-center mb-5">
              ...
              <div className="icon-area">
                <span>
                  ...
                  >
                    <path
                      d="M21.668 42C33.2659 42 42.668 32.598 42.668 21C42.668 9.40202 33.2659 0 21.668 0C10.07 0 0.667969 9.40202 0.667969 21C0.667969 32.598 10.07 42 21.668 42Z"
                      fill="#627EEA"
                    />
                    <path
                      d="M22.3203 5.25V16.8919L32.1601 21.2887L22.3203 5.25Z"
                      fill="white"
                      fillOpacity="0.602"
                    />
                    <path
                      d="M22.3216 5.25L12.4805 21.2887L22.3216 16.8919V5.25Z"
                      fill="white"
                    />
                    <path
                      d="M22.3203 28.8331V36.7435L32.1667 23.1211L22.3203 28.8331Z"
                      fill="white"
                      fillOpacity="0.602"
                    />
                    <path
                      d="M22.3216 36.7435V28.8318L12.4805 23.1211L22.3216 36.7435Z"
                      fill="white"
                    />
                    <path
                      d="M22.3203 27.0021L32.1601 21.2888L22.3203 16.8945V27.0021Z"
                      fill="white"
                      fillOpacity="0.2"
                    />
                    <path
                      d="M12.4805 21.2887L22.3216 27.002V16.8944L12.4805 21.2887Z"
                      fill="white"
                      fillOpacity="0.602"
                    />
                  </svg>
              ...
              {/* heading */}
              <div className="heading flex space-x-1 items-center">
                ...
                <span>
                  ...
                  >
                    <path
                      d="M14.3772 0.288658C14.2843 0.197192 14.1737 0.124593 14.0518 0.0750502C13.93 0.025507 13.7993 0 13.6673 0C13.5353 0 13.4046 0.025507 13.2828 0.0750502C13.1609 0.124593 13.0503 0.197192 12.9574 0.288658L8.37789 4.7581C8.28494 4.84956 8.17435 4.92216 8.0525 4.9717C7.93066 5.02125 7.79997 5.04676 7.66797 5.04676C7.53597 5.04676 7.40528 5.02125 7.28344 4.9717C7.16159 4.92216 7.051 4.84956 6.95805 4.7581L2.37857 0.288658C2.28562 0.197192 2.17503 0.124593 2.05318 0.0750502C1.93134 0.025507 1.80064 0 1.66865 0C1.53665 0 1.40596 0.025507 1.28411 0.0750502C1.16227 0.124593 1.05168 0.197192 0.958728 0.288658C0.772498 0.471497 0.667969 0.718831 0.667969 0.976639C0.667969 1.23445 0.772498 1.48178 0.958728 1.66462L5.54821 6.14382C6.11065 6.69206 6.87306 7 7.66797 7C8.46288 7 9.22529 6.69206 9.78773 6.14382L14.3772 1.66462C14.5634 1.48178 14.668 1.23445 14.668 0.976639C14.668 0.718831 14.5634 0.471497 14.3772 0.288658Z"
                      fill="#374557"
                    />
                  </svg>
                </span>
        ...
        <div className="top-creator bg-white rounded-2xl p-8 2xl:w-[268px] w-full 2xl:mb-10 2xl:border-none  border ">
          ...
          <div className="heading flex justify-between items-center mb-3.5">
            <h3 className="text-xl font-bold text-dark-gray">Top creatore</h3>
            <div className="flex space-x-1 items-center">
          ...
          <div className="creator-list">
            <div className="item flex justify-between items-center border-b hover:bg-gray-50 py-2.5">
              {/* image */}
