        ...
        <div className="flex justify-between items-center">
          <div className="account-name flex space-x-4 items-center">
            ...
            <div>
              ...
              <div className="time">
                <p className="text-sm text-thin-light-gray font-medium truncate text-ellipsis">
                  {product.title}
                </p>
              </div>
              <div className="time">
                  ...
                  <ul className="items-center w-full text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                      <div className="flex items-center pl-3">
                        <input
                          id="horizontal-list-radio-ERC20"
                          type="radio"
                          value=""
                          name="list-radio"
                    ...
                    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                      <div className="flex items-center pl-3">
                        <input
                          id="horizontal-list-radio-ERC721"
                          type="radio"
                          value=""
                          name="list-radio"
                          className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                    ...
                    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                      <div className="flex items-center pl-3">
                        <input
                          id="horizontal-list-radio-ERC1155"
                          type="radio"
                          value=""
                          name="list-radio"
                          className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                    ...
                    <li className="w-full dark:border-gray-600">
                      <div className="flex items-center pl-3">
                        <input
                          id="horizontal-list-radio-ERC4907"
                          type="radio"
                          value=""
                          name="list-radio"
                          className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                ...
                <div className="flex mt-5">
                  ...
                  <div className="relative w-full">
                    <input
                      ...
                      {...register("assetsToLend", {
                        required: "please enter assetsToLend",
                      })}
                    />
      ...
      {confirmationLend && (
        <ModalCom action={confirmationLendHandler} situation={confirmationLend}>
          <div className="lg:w-[450px] sm:w-[350px] w-full rounded-2xl h-auto bg-white">
            <div className="heading border-b border-light-purple lg:px-7 sm:px-5 px-3 py-6 flex items-center justify-between">
              <h3 className="text-xl font-bold text-dark-gray">I lending</h3>
                  ...
                  <div className="ready-order">
                    <div className="mb-8 border-2 border-lime-400 p-[23px] rounded-lg">
                      ...
                      <p className="text-[18px]">
                        You can see it in your dashboard along with your other
                        open orders and your history
                      </p>
                    </div>
                  </div>
                </div>
